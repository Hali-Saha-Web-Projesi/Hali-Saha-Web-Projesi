        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KullaniciSoyad = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TesisId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TesisAdi = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TesisAdresi = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TesisResmi = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TesisDegerlendirmesi = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TesisPuani = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
